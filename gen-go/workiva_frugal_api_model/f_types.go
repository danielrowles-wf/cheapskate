...
func (p *Info) writeField1(oprot thrift.TProtocol) error {
...
func (p *Info) writeField2(oprot thrift.TProtocol) error {
...
func (p *Info) writeField3(oprot thrift.TProtocol) error {
...
func (p *Info) writeField4(oprot thrift.TProtocol) error {
	if p.IsSetActiveRequests() {
...
func (p *Info) writeField5(oprot thrift.TProtocol) error {
	if p.IsSetMetadata() {
...
type ServiceHealthStatus struct {
	...
	// A descriptive message that elaborates upon a status
...
func (p *ServiceHealthStatus) writeField1(oprot thrift.TProtocol) error {
...
func (p *ServiceHealthStatus) writeField2(oprot thrift.TProtocol) error {
...
func (p *ServiceHealthStatus) writeField3(oprot thrift.TProtocol) error {
...
func (p *ServiceHealthStatus) writeField4(oprot thrift.TProtocol) error {
	if p.IsSetMetadata() {
...
func (p *Health) writeField1(oprot thrift.TProtocol) error {
...
func (p *Health) writeField2(oprot thrift.TProtocol) error {
...
type BaseError struct {
	// The specific problem flagged by this error, if any
...
func (p *BaseError) writeField1(oprot thrift.TProtocol) error {
...
func (p *BaseError) writeField2(oprot thrift.TProtocol) error {
	if err := oprot.WriteFieldBegin("message", thrift.STRING, 2); err != nil {
		return thrift.PrependError(fmt.Sprintf("%T write field begin error 2:message: ", p), err)
	}
	if err := oprot.WriteString(string(p.Message)); err != nil {
